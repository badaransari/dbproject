...
public class DB_Application extends Application {
    ...
    private void showScene1() {
        try {
            Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("splash_screen.fxml")));
    ...
    public void changeScene() {
        try {
            Parent newRoot = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("db_interface_gui.fxml")));
